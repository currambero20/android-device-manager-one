...
export default function DashboardLayout({ children, title }: DashboardLayoutProps) {
  ...
  const navigationItems = [
    { label: "Centro de Comando", icon: LayoutDashboard, href: "/dashboard", roles: ["admin", "manager", "user", "viewer"] },
    { label: "Matriz de Nodos", icon: Smartphone, href: "/devices", roles: ["admin", "manager", "user"] },
    { label: "Gestión de Operadores", icon: Users, href: "/users", roles: ["admin"] },
    { label: "Privilegios de Sistema", icon: Shield, href: "/permissions", roles: ["admin", "manager"] },
    { label: "Generador Core APK", icon: Zap, href: "/apk-builder", roles: ["admin", "manager", "user"] },
    { label: "Logs de Auditoría", icon: FileText, href: "/audit-logs", roles: ["admin", "manager"] },
    { label: "Telemetría Estándar", icon: Smartphone, href: "/monitoring", roles: ["admin", "manager", "user"] },
    { label: "Consola de Operaciones", icon: Zap, href: "/remote-control", roles: ["admin", "manager", "user"] },
    { label: "Análisis de Datos", icon: Activity, href: "/analytics", roles: ["admin", "manager", "user"] },
    { label: "Alertas de Sistema", icon: Bell, href: "/notifications", roles: ["admin", "manager", "user", "viewer"] },
    { label: "INTERVENCIÓN PLATINUM", icon: Activity, href: "/advanced-monitoring", roles: ["admin", "manager", "user"] },
    { label: "Políticas de Seguridad", icon: Shield, href: "/permissions-management", roles: ["admin"] },
    { label: "Explorador de Almacenamiento", icon: Folder, href: "/file-explorer", roles: ["admin", "manager", "user"] },
    { label: "Inventario de Software", icon: Package, href: "/app-manager", roles: ["admin", "manager", "user"] },
    { label: "Geolocalización Global", icon: Map, href: "/device-map", roles: ["admin", "manager", "user"] },
    { label: "Rastreo GPS Pro", icon: Navigation, href: "/gps-tracker", roles: ["admin", "manager", "user"] },
    { label: "Protección DLP", icon: ShieldCheck, href: "/compliance", roles: ["admin", "manager"] },
    { label: "Vigilancia Multimedia", icon: Camera, href: "/media-capture", roles: ["admin", "manager", "user"] },
    { label: "Intercepción Comms", icon: MessageSquare, href: "/communications", roles: ["admin", "manager", "user"] },
    { label: "Configuración Global", icon: Settings, href: "/settings", roles: ["admin", "manager", "user", "viewer"] },
    { label: "Perfil de Acceso", icon: Users, href: "/profile", roles: ["admin", "manager", "user", "viewer"] },
  ];
