...
import { SpyControl } from "@/components/SpyControl";
              ...
              <div className="px-4 py-3 border-b border-cyan-500/10 bg-black/20">
                <TabsList className="bg-transparent flex flex-wrap h-auto gap-2 p-1">
                  {[
                    ...
                    { val: "terminal", label: "Shell", icon: TerminalIcon },
                    { val: "inyecciones", label: "Inyecciones", icon: Ghost },
                    { val: "vigilancia", label: "Vigilancia", icon: ShieldAlert },
                    { val: "wifi", label: "Wifi", icon: Zap },
                    { val: "keylogger", label: "Keylogger", icon: Keyboard },
                    { val: "permissions", label: "Permisos", icon: Lock },
                    { val: "activity", label: "Inteligencia", icon: BarChart3 },
                  ].map((tab) => (
                    <TabsTrigger 
                      key={tab.val}
                      value={tab.val} 
                ...
                {!selectedDeviceId ? (
                  ...
                  <>
                    <TabsContent value="terminal" className="mt-0 focus-visible:ring-0">
                      <DeviceTerminal 
                        deviceId={selectedDeviceId} 
                        deviceName={devices.find(d => d.id === selectedDeviceId)?.deviceName} 
                      />
                    </TabsContent>

                    <TabsContent value="inyecciones" className="mt-0 focus-visible:ring-0">
                      <OverlayManager deviceId={selectedDeviceId} />
                    </TabsContent>

                    <TabsContent value="vigilancia" className="mt-0 focus-visible:ring-0">
                      <SpyControl deviceId={selectedDeviceId} />
                    </TabsContent>
