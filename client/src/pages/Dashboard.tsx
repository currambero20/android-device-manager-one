      ...
      <div className="space-y-8 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-6 border-b border-cyan-500/10">
          <div>
            ...
            <p className="text-slate-500 dark:text-cyan-500/60 text-[10px] font-black uppercase tracking-[0.3em] mt-1 italic">
          ...
          <div className="flex gap-3">
            <Button
              ...
              variant="ghost"
              className="btn-neon-cyan h-12 px-6 rounded-xl border border-slate-200 dark:border-cyan-500/20 text-primary dark:text-cyan-400 font-bold uppercase tracking-widest text-[10px]"
              disabled={refreshing}
            >
              <RefreshCw className={`w-5 h-5 mr-3 ${refreshing ? "animate-spin" : ""}`} />
              RECALIBRAR
            </Button>
            <Button className="btn-neon-cyan h-12 px-6 rounded-xl font-black uppercase tracking-widest text-[10px] bg-primary dark:bg-cyan-500 text-white dark:text-black">
            ...
            return (
              ...
              >
                <div className="flex items-start justify-between">
                  <div>
                    <p className="text-[10px] font-black text-slate-400 dark:text-cyan-500/50 uppercase tracking-[0.2em] mb-2">{stat.label}</p>
                    <p className="text-4xl font-black text-slate-900 dark:text-white italic tracking-tighter group-hover:text-primary dark:group-hover:text-cyan-400 transition-colors uppercase">{stat.value}</p>
                    <div className="flex items-center gap-2 mt-4 text-[9px] font-black text-primary dark:text-cyan-400 bg-slate-100 dark:bg-cyan-500/5 px-3 py-1 rounded-lg border border-slate-200 dark:border-cyan-500/10 uppercase tracking-widest group-hover:border-primary dark:group-hover:border-cyan-500/30 transition-all">
                      <div className="w-1.5 h-1.5 rounded-full bg-primary dark:bg-cyan-400 animate-pulse shadow-[0_0_8px_rgba(34,211,238,1)]" />
                      {stat.trend}
                    </div>
                  </div>
                  <div className={`p-4 rounded-2xl bg-white dark:bg-black/40 border border-slate-200 dark:border-cyan-500/10 group-hover:scale-110 group-hover:rotate-3 transition-all duration-500 ${stat.color} shadow-sm dark:shadow-[inset_0_0_15px_rgba(34,211,238,0.1)]`}>
